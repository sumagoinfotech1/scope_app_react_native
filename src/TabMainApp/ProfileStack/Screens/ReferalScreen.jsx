...
//           } else {
//             const errorMessage = response.data?.message || "Failed to create referral";
//             setErrorOccured(true);
//             setError(errorMessage);
//             showToast("error", "Referral Failed", errorMessage);
//           }
//         } catch (error) {
//           setErrorOccured(true);
...
//             const errorMessage = data?.message || "Error creating referral";
      
//             if (status === 400 && data?.result === false) {
...
//             showToast("error", "Network Error", networkError);
//           }
//         } finally {
//           setLoading(false);
//         }
